...
ON c.[CustomerID] = ca.[CustomerID]-- join based on CustomerID
	INNER JOIN [SalesLT].[Address] AS a 
ON a.[AddressID] = ca.[AddressID]----join based on AddressID
WHERE ca.[AddressType] = 'Main Office';-- filter the results where AddressType is main office
